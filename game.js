...
class Game {
    ...
    printAllValues() {
        console.log('Cureent Selection:' + constants.currentSelection);
        console.log('Last Selection:' + constants.lastSelection);
        console.log('validSelections:' + constants.validSelections);
    }
}